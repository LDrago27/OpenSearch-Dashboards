...
import { EarliestLatestFunctionCallContext } from "./OpenSearchPPLParser.js";
import { StatsFunctionNameContext } from "./OpenSearchPPLParser.js";
import { EarliestLatestFunctionContext } from "./OpenSearchPPLParser.js";
...
export class OpenSearchPPLParserVisitor<Result> extends AbstractParseTreeVisitor<Result> {
    ...
    /**
     * Visit a parse tree produced by the `earliestLatestFunctionCall`
     * labeled alternative in `OpenSearchPPLParser.statsFunction`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitEarliestLatestFunctionCall?: (ctx: EarliestLatestFunctionCallContext) => Result;
    /**
    ...
    /**
     * Visit a parse tree produced by `OpenSearchPPLParser.earliestLatestFunction`.
     * @param ctx the parse tree
     * @return the visitor result
     */
    visitEarliestLatestFunction?: (ctx: EarliestLatestFunctionContext) => Result;
    /**
